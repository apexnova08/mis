...
Rectangle
{
    ...
    QtObject
    {
        ...
        function cancelRequest()
        {
            ...
            {
                backend.PopupFunc("PRINT CANCEL BGYCLEARANCE")
            }
            else
            {
    ...
    Connections
    {
        ...
        {
            if (typeString == "PRINT BGYCLEARANCE")
            {
        ...
        function onPrintDocument(page)
        {
            if (page == "BGYCLEARANCE")
            {
                backend.PrintBgyClearance(resPK, txtPurpose.text)
            }
        }
    ...
    Rectangle
    {
        ...
        Label
        {
            ...
            text: qsTr("<b>Print Barangay Clearance</b>")
            color: "#ffffff"
            font.pixelSize: 17
    ...
    CustomPopup
    {
        ...
        popFunc: "PRINT CANCEL BGYCLEARANCE"
        isWarning: true
    }
