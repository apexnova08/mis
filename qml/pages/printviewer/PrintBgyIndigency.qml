...
Rectangle
{
    ...
    QtObject
    {
        ...
        function cancelRequest()
        {
            ...
            {
                backend.PopupFunc("PRINT CANCEL BGYINDIGENCY")
            }
            else
            {
    ...
    Connections
    {
        ...
        {
            if (typeString == "PRINT BGYINDIGENCY")
            {
        ...
        function onPrintDocument(page)
        {
            if (page == "BGYINDIGENCY")
            {
                backend.PrintBgyIndigency(resPK, txtPurpose.text)
            }
        }
    ...
    Rectangle
    {
        ...
        Label
        {
            ...
            text: qsTr("<b>Print Barangay Indigency</b>")
            color: "#ffffff"
            font.pixelSize: 17
    ...
    CustomPopup
    {
        ...
        popFunc: "PRINT CANCEL BGYINDIGENCY"
        isWarning: true
    }
